...
class TenantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tenant" do
    assert_difference("Tenant.count") do
      post tenants_url, params: { tenant: { domain: @tenant.domain, name: @tenant.name, subdomain: @tenant.subdomain } }
    end
  ...
  test "should update tenant" do
    patch tenant_url(@tenant), params: { tenant: { domain: @tenant.domain, name: @tenant.name, subdomain: @tenant.subdomain } }
