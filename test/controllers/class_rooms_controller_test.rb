...
class ClassRoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_room" do
    assert_difference("ClassRoom.count") do
      post class_rooms_url, params: { class_room: { capacity: @class_room.capacity, name: @class_room.name } }
    end
  ...
  test "should update class_room" do
    patch class_room_url(@class_room), params: { class_room: { capacity: @class_room.capacity, name: @class_room.name } }
