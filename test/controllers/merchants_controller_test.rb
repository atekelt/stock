...
class MerchantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchant" do
    assert_difference("Merchant.count") do
      post merchants_url, params: { merchant: { api_key: @merchant.api_key, code: @merchant.code, name: @merchant.name } }
    end
  ...
  test "should update merchant" do
    patch merchant_url(@merchant), params: { merchant: { api_key: @merchant.api_key, code: @merchant.code, name: @merchant.name } }
