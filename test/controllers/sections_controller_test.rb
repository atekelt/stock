...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference("Section.count") do
      post sections_url, params: { section: { name: @section.name, section_no: @section.section_no } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { name: @section.name, section_no: @section.section_no } }
