...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference("Attendance.count") do
      post attendances_url, params: { attendance: { date: @attendance.date, present: @attendance.present, student_id: @attendance.student_id } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { date: @attendance.date, present: @attendance.present, student_id: @attendance.student_id } }
