...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference("Assessment.count") do
      post assessments_url, params: { assessment: { teacher_assignment_id: @assessment.teacher_assignment_id, max: @assessment.max, status: @assessment.status } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { teacher_assignment_id: @assessment.teacher_assignment_id, max: @assessment.max, status: @assessment.status } }
