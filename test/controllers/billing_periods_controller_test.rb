...
class BillingPeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create billing_period" do
    assert_difference("BillingPeriod.count") do
      post billing_periods_url, params: { billing_period: { duration: @billing_period.duration, miscellaneous_fee: @billing_period.miscellaneous_fee, miscellaneous_fee_reason: @billing_period.miscellaneous_fee_reason, payment_type_id: @billing_period.payment_type_id, start_date: @billing_period.start_date } }
    end
  ...
  test "should update billing_period" do
    patch billing_period_url(@billing_period), params: { billing_period: { duration: @billing_period.duration, miscellaneous_fee: @billing_period.miscellaneous_fee, miscellaneous_fee_reason: @billing_period.miscellaneous_fee_reason, payment_type_id: @billing_period.payment_type_id, start_date: @billing_period.start_date } }
