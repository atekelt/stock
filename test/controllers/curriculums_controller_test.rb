...
class CurriculumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curriculum" do
    assert_difference("Curriculum.count") do
      post curriculums_url, params: { curriculum: { amharic_name: @curriculum.amharic_name, description: @curriculum.description, name: @curriculum.name, school_level_id: @curriculum.school_level_id } }
    end
  ...
  test "should update curriculum" do
    patch curriculum_url(@curriculum), params: { curriculum: { amharic_name: @curriculum.amharic_name, description: @curriculum.description, name: @curriculum.name, school_level_id: @curriculum.school_level_id } }
