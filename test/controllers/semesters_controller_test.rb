...
class SemestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semester" do
    assert_difference("Semester.count") do
      post semesters_url, params: { semester: { name: @semester.name, sequence: @semester.sequence } }
    end
  ...
  test "should update semester" do
    patch semester_url(@semester), params: { semester: { name: @semester.name, sequence: @semester.sequence } }
