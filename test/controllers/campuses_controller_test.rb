...
class CampusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campus" do
    assert_difference("Campus.count") do
      post campuses_url, params: { campus: { name: @campus.name, school_id: @campus.school_id } }
    end
  ...
  test "should update campus" do
    patch campus_url(@campus), params: { campus: { name: @campus.name, school_id: @campus.school_id } }
