...
class StudentGradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_grade" do
    assert_difference("StudentGrade.count") do
      post student_grades_url, params: { student_grade: { academic_year_id: @student_grade.academic_year_id, grade_id: @student_grade.grade_id, student_id: @student_grade.student_id } }
    end
  ...
  test "should update student_grade" do
    patch student_grade_url(@student_grade), params: { student_grade: { academic_year_id: @student_grade.academic_year_id, grade_id: @student_grade.grade_id, student_id: @student_grade.student_id } }
