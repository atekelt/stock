...
class PaymentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_type" do
    assert_difference("PaymentType.count") do
      post payment_types_url, params: { payment_type: { amount_id: @payment_type.amount_id, description: @payment_type.description, name: @payment_type.name, school_level_id: @payment_type.school_level_id } }
    end
  ...
  test "should update payment_type" do
    patch payment_type_url(@payment_type), params: { payment_type: { amount_id: @payment_type.amount_id, description: @payment_type.description, name: @payment_type.name, school_level_id: @payment_type.school_level_id } }
