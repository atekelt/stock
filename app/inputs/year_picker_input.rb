...
class YearPickerInput < SimpleForm::Inputs::StringInput
  ...
  def display_pattern
    I18n.t('datepicker.dformat', default: '%Y')
  end

  def picker_pattern
    I18n.t('datepicker.pformat', default: 'YYYY')
  end

  def date_view_header_format
    I18n.t('dayViewHeaderFormat', default: 'YYYY')
  end
